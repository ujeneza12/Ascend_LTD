      ...
      <div className="flex justify-end">
        ...
        <div className="grid grid-cols-4 gap-4  w-[66%] mx-[6rem] p-2">
          {Pics.data.picture.map((pic) => (
            ...
            <Link to={`/Product?id=${pic.id}&picName=${pic.name}&picSrc=${"https://images.unsplash.com/photo-1565084888279-aca607ecce0c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8ODh8fGNsb3RoaW5nfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"}`} >
              <img src={pic.src} alt="pic" className="h-[63%] rounded-[13px] bg-blue-400 w-full " />
            </Link>
