 ...
 function SignUp(){
    ...
    return(
      ...
      <div className=" grid gri-cols-1 sm:grid-cols-2 h-screen w-[100%] mx-auto overflow-hidden ">
          <div className="hidden sm:block bg-blue-800 h-screen">
              hy
          </div>
          <div className="w-[100%] mx-auto bg-blue-800 ">
              <form className="max-w-[100%] w-full max-auto bg-white p-20  h-screen gb-red-300">
                  ...
                  <div className="flex flex-col py-3">
                      <input className="border p-2 rounded-lg  w-[100%]" type="text" placeholder="Enter your Email/phone number " name="email" value={values.email} onChange={handleChange }/>
                      {errors.email && <p className="error">{errors.email}</p>}
                  </div>
                  <div className="flex flex-col py-3">
                      <input className="border p-2 rounded-lg" type="password" placeholder="Enter your password " name="password" value={values.password} onChange={handleChange}/>
